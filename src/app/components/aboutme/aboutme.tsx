...
export default function Aboutme() {
  return (
      <Box id="aboutme"  sx={{ pt: 1, pb: 15 ,textAlign:'center'}}>
        <Grid container direction='column' sx={{ pt: 10 }} maxWidth={1200} alignItems='center' justifyContent='center'>
          ...
          <Grid container item xs={12} sm={12} md={12} lg={12} sx={{ pt: 5 }} alignItems={"center"} justifyContent='center' >
            {/* Grid 1 */}
            <Grid item xs={12} sm={12} md={6} lg={6} p={5} alignItems={"center"} justifyContent='center'>
